...
<body id="home">
    ...
    <div class="container-fluid"> --}}
        ...
        <!-- ==============================================feature title here======================================= -->
        <div class="px-4 py-5 mb-4 bg-light rounded-4" data-aos="zoom-in-down">
            <h2 class="pb-2 border-bottom">Our Company Details</h2>

            <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
                <div class="d-flex flex-column align-items-start gap-2">
                    <h3 class="fw-bold">multi-national IT tranning center</h3>
                    <p class="text-muted">we will provide highly skilled and qualified trainer for you can learn easily.
                        And you have great knowdge about programming language.</p>
                    <a href="#featured-3" class="btn btn-success btn-lg">See More</a>
                </div>
        ...
        <div class="px-4 py-5 rounded-4 bg-light" id="featured-3" data-aos="zoom-in-right">
            <h2 class="pb-2 border-bottom">Our Mentor and Trainer</h2>
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                <div class="feature col km">
                    <div
        ...
        <div class="px-4 py-5 rounded-4" id="hanging-icons" data-aos="zoom-in-left">
            ...
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                <div class="col d-flex align-items-start km">
                    <div
                    ...
                    <div>
                        ...
                        <p>Whether you're new to programming or an experienced developer, it's easy to learn and use
                ...
                <div class="col d-flex align-items-start km">
                    ...
                    <div>
                        ...
                        <p>A popular general-purpose scripting language that is especially suited to web development.
                            ...
                            websites in the world.A good place to start is by skimming through the ever-growing list.
                        </p>
                        <p><del> 15,000 TK</del> 12,000 TK</p>
                        <a href="#" class="btn btn-success">
                            Enroll Now
                ...
                <div class="col d-flex align-items-start km">
                    ...
                    <div>
                        ...
                        <p>JavaScript (JS) is a lightweight, interpreted with first-class functions. While it is most
                            well-known as the scripting language for Web pages, many non-browser environments also use
                            it, such as Node.js. JavaScript is a prototype-based,dynamic language</p>
                        <p><del> 15,000 TK</del> 12,000 TK</p>
                        <a href="#" class="btn btn-success">
                            Enroll Now
                        </a>
