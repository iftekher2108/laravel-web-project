...
<body id="home">
    ...
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{url('addstudentform')}}">addstudentform</a>
          </li>
          <li class="nav-item">
                ...
                <form action="{{url('/update'),$student->id }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="form-floating mb-2">
                        <input type="text" name="roll" value="{{ $student->id }}" class="form-control form-control-sm" id="floatingInput" placeholder="name@example.com">
                      ...
                      <div class="form-floating mb-2">
                        <select class="form-select" name="technology" id="floatingSelect" aria-label="Floating label select example">
                          <option value="{{ $student->technology }}" selected>Select One Of Them</option>
                      ...
                      <div class="form-floating mb-2">
                        <select class="form-select" name="semister" id="floatingSelect" aria-label="Floating label select example">
                          <option value="{{ $student->semister }}" selected>Select One Of Them</option>
                          <option >First</option>
                      ...
                      <div class="form-floating mb-2">
                        <select class="form-select" name="shift" id="floatingSelect" aria-label="Floating label select example">
                          <option value="{{ $student->shift }}" selected>Select One Of Them</option>
                      ...
                      <div class="form-floating mb-2">
                        <select class="form-select" name="group" id="floatingSelect" aria-label="Floating label select example">
                          <option value="{{ $student->group }}" selected>Select One Of Them</option>
