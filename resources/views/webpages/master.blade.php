...
<body id="home">
    ...
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid ">
            <a class="navbar-brand" href="#"><img class="rounded-circle" src=" {{ asset('image/iftekher.jpg') }}"
                    alt="website logo" height="50" width="50"></a>
            ...
            <footer class="py-5">
                <div class="row">
                    <div class="col-lg-5 col-md-2 mb-3">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="javascript:void(0)"
                                    class="nav-link p-0 text-muted">Email: iftekhermahmud@gmail.com</a></li>
                            <li class="nav-item mb-2"><a href="javascript:void(0)"
                                    class="nav-link p-0 text-muted">Phone: (+880 17**-****</a></li>
                            <li class="nav-item mb-2"><a href="javascript:void(0)"
                                    class="nav-link p-0 text-muted">Address: Bheramara, Kushtia</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2 mb-3">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a href="{{ url('gellery') }}"
                                    class="nav-link p-0 text-muted">Gallery</a></li>
                            <li class="nav-item mb-2"><a href="{{ url('blog') }}"
                                    class="nav-link p-0 text-muted">Blog</a></li>
                            <li class="nav-item mb-2"><a href="{{ url('about') }}"
                                    class="nav-link p-0 text-muted">About Us</a></li>
                            <li class="nav-item mb-2"><a href="{{ url('policy') }}"
                                    class="nav-link p-0 text-muted">Private Policy</a></li>
                        </ul>
                    </div>
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between py-2 my-2 border-top">
                    ...
                    <ul class="list-unstyled d-flex">
                        ...
                        <li class="ms-3"><a class="link-light" title="Instagram"
                                href="https://www.instagram.com/"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="ms-3"><a class="link-light" title="Facebook"
                        ...
                        <li class="ms-3"><a class="link-light" title="Whatsapp"
                                href="https://web.whatsapp.com/"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="25" height="25" fill="currentColor" class="bi bi-whatsapp"
                                    viewBox="0 0 16 16">
                                    <path
